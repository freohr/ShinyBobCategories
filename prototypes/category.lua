...
if data.raw["item-group"]["logistics"] then
    ...
    data:extend({
        ...
        { type = "item-subgroup", name = "addon-loader", group = "logistics", order = "b-4", },
        ...
        { type = "item-subgroup", name = "addon-aai-miners", group = "logistics", order = "e-2" },
        { type = "item-subgroup", name = "addon-aai-vehicles", group = "logistics", order = "e-3" },
        { type = "item-subgroup", name = "addon-cars-tanks", group = "logistics", order = "e-4", },
...
if data.raw["item-group"]["bob-logistics"] then
    data:extend({
        ...
        { type = "item-subgroup", name = "flow-control-1", group = "bob-logistics", order = "d-a" },
        { type = "item-subgroup", name = "addon-fluid-management", group = "bob-logistics", order = "d-b", },


        { type = "item-subgroup", name = "addon-trains-management", group = "bob-logistics", order = "e-1", },
        { type = "item-subgroup", name = "addon-trains", group = "bob-logistics", order = "e-2", },
        { type = "item-subgroup", name = "addon-cargo-wagons", group = "bob-logistics", order = "e-3", },
        { type = "item-subgroup", name = "addon-fluid-wagons", group = "bob-logistics", order = "e-4", },
...
if data.raw["item-group"]["intermediate-products"] then
    data:extend({
        ...
        { type = "item-subgroup", name = "addon-treefarm", group = "intermediate-products", order = "j", },
    })
end
...
if vehicleequipment_menu_graphics then
    data:extend({
        --- - ADDON EQUIPMENT
        { type = "item-group", name = "addon-vehicleequipment", order = "d-a", icon = "__ShinyBobCategories__/graphics/icons/menu/equipment.png", },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-1", group = "addon-vehicleequipment", order = "a" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-2", group = "addon-vehicleequipment", order = "b" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-3", group = "addon-vehicleequipment", order = "c" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-4", group = "addon-vehicleequipment", order = "d" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-5", group = "addon-vehicleequipment", order = "e" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-6", group = "addon-vehicleequipment", order = "d" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-7", group = "addon-vehicleequipment", order = "e" },
        { type = "item-subgroup", name = "addon-bob-vehicleequipment-8", group = "addon-vehicleequipment", order = "e" },
        { type = "item-subgroup", name = "addon-robots1-equipment", group = "addon-vehicleequipment", order = "f" },
        { type = "item-subgroup", name = "addon-robots2-equipment", group = "addon-vehicleequipment", order = "g" },
        { type = "item-subgroup", name = "addon-robots3-equipment", group = "addon-vehicleequipment", order = "h" },
    })
end
